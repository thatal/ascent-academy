    ...
    <div class="row">
      <div class="col-12 col-md-12">
        ...
        <div class="qr_wrapper">
          <img style="max-width: 120px;" height="120px" width="120px" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(300)->generate($application->id))!!}" />
        </div>
          ...
          <table width="100%" style="margin-bottom:20px;">
           <tbody>
            <tr>
             ...
             <td align="right"><img style="max-width: 120px;" height="120px" width="120px" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(300)->generate($application->id))!!}" /></td>
           </tr>
         </tbody>
       </table>
       <div class="row">

...
<div class="row">
    ...
    <div class="col-md-4 col-lg-4 form-group">
        ...
        <select class="form-control form-control-sm subjects compulsory" name="subjects[1]" required
            ...
            <option value="NA" {{(old("subjects[1]") == "NA" ? "selected" : "")}} @isset($application) selected
                @endisset>NA</option>
            @endif
    ...
    <div class="col-md-4 col-lg-4 form-group">
        ...
        <select class="form-control form-control-sm subjects" name="subjects[{{$number-1}}]" required
            data-subject-no="Subject {{$number}}">
            <option value="" selected disabled>--SELECT--</option>
            @if($other_subjects->where("subject_no", $number)->count() == 0)
            <option value="NA" {{(old("subjects[($number-1)]") == "NA" ? "selected" : "")}} @isset($application)
                selected @endisset>NA</option>
            @endif
            @foreach($other_subjects->where("subject_no", $number)->sortBy("name")->values()->all() as $subject)
            <option value="{{$subject->id}}"
                {{(old("subjects[($number-1)]", findSubjectInAppliedSubject($application->appliedSubjects, $subject->id)) == $subject->id ? "selected" : "")}}>
                {{$subject->name}}</option>
            @endforeach
            @if($other_subjects->where("subject_no", $number)->count() > 0)
...
<div class="alert alert-info">
    <strong>Notice !</strong> If the major subject selected as Psychology or Home Science. Free admission will not be
    not applied.
</div>
{{-- for Degree --}}
<div class="row">
    <div class="col-md-4 col-lg-4">
        <div class="form-group">
            ...
            <select class="form-control form-control-sm subjects major" name="subjects[0]" required
    ...
    <div class="col-md-4 col-lg-4 form-group">
        ...
        <select class="form-control form-control-sm subjects" name="subjects[2]" required
            data-subject-no="Compulsory Subject 2">
            <option value="" selected disabled>--SELECT--</option>
            @if($other_subjects->where("subject_no", 3)->count() == 0)
            <option value="NA" {{(old("subjects[2]") == "NA" ? "selected" : "")}} @isset($application) selected
                @endisset>NA</option>
            @endif
...
<div class="row">
    ...
    <div class="col-md-4 col-lg-4 form-group">
        ...
        <select class="form-control form-control-sm subjects compulsory" name="subjects[2]" required
            data-subject-no="Generic Subject">
            <option value="" selected disabled>--SELECT--</option>
            @if($other_subjects->where("subject_no", 3)->count() == 0)
            <option value="NA" @isset($application) selected @endisset>NA</option>
            @endif
...
<div class="row">
    <div class="col-md-4 col-lg-4 form-group">
        ...
        <select class="form-control form-control-sm subjects compulsory" name="subjects[0]" required
            data-subject-no="Paper 1 Subject">
            <option value="" selected disabled>--SELECT--</option>
            @if($compulsory_subjects->where("subject_no", 1)->count() == 0)
            <option value="NA" @isset($application) selected @endisset>NA</option>
            @endif
    ...
    <div class="col-md-4 col-lg-4 form-group">
        ...
        <select class="form-control form-control-sm subjects compulsory" name="subjects[1]" required
            data-subject-no="Paper 2 Subject">
            <option value="" selected disabled>--SELECT--</option>
            @if($compulsory_subjects->where("subject_no", 2)->count() == 0)
            <option value="NA" @isset($application) selected @endisset>NA</option>
            @endif
    ...
    <div class="col-md-4 col-lg-4 form-group">
        ...
        <select class="form-control form-control-sm subjects compulsory" name="subjects[2]" required
            data-subject-no="Paper 3 Subject">
            <option value="" selected disabled>--SELECT--</option>
    ...
    <div class="col-md-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="custom-controls-stacked">
                ...
                <label class="custom-control custom-radio custom-control-inline"><input type="radio" name="category"
                        id="category" data-original-id="{{$application->caste_id}}" value="{{$category->id}}" required
                        class="custom-control-input" @if($application->selected_category_id == $category->id)
                    {{"checked"}}
        ...
        <div class="form-group" id="remarks" style="{{$application->selected_caste_reason ? '' : 'display: none;'}}">
            <label class="form-label">Reason for changing resevation category.<span
                    class="form-required">*</span></label>
            <textarea name="reason" class="form-control"
                placeholder="Reason for changing reservation category. min 5 character."
                minlength="5">{{$application->selected_caste_reason}}</textarea>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="custom-controls-stacked">
                <label class="custom-control custom-radio custom-control-inline"><input type="radio" name="practical"
                        id="with_practical" value="1" required class="custom-control-input"
                        {{$application->with_practical ? "checked": "" }}><span class="custom-control-label">
                        Yes</span></label>
                <label class="custom-control custom-radio custom-control-inline"><input type="radio" name="practical"
                        id="without_practical" value="0" required class="custom-control-input"
                        {{$application->with_practical ? "": "checked" }}><span class="custom-control-label">
                        No</span></label>
            </div>
        </div>
        {{-- free admission hidden field --}}
        <input type="hidden" name="free_admission" id="free_admission" value="{{$application->free_admission}}"
            data-old="{{$application->free_admission}}">
    </div>
</div>
@endif

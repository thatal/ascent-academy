...
class EditedApplication extends Model
{
    use SoftDeletes;
    ...
    protected $with = ['appliedSubjects','appliedStream','student','course','semester','caste','attachments','receipt','admittedStudent','paymentReceipt'];
    ...
    public function editedAppliedSubjects()
    {
        return $this->hasMany('App\Models\EditedAppliedSubject', 'edited_application_id', 'id');
    }
    public function appliedStream()
    {
        return $this->hasOne('App\Models\AppliedStream', 'application_id', 'id');
    }
    public function editedAppliedStream()
    {
        return $this->hasOne('App\Models\EditedAppliedStream', 'edited_application_id', 'id');
    }
    ...
    public static $rules = [
        ...
        'annual_income'     => 'required|digits_between:1,20|numeric',

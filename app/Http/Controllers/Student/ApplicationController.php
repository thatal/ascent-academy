...
use DB, Session, Log, Exception, Str, Image, Validator;
...
class ApplicationController extends Controller
{
    ...
    function createStreamAndSubject($request,$application)
    {
        $applied_stream_data = [
            'uuid' => (String) Str::uuid(),
            'student_id' => auth()->id(),
...
*/    }
    ...
    {
        return view('student.application.payment-receipt',compact('application'));
    }
    ...
    function createOnlyStream($request, $application)
    {
        $applied_stream_data = [
            'uuid'          => (String) Str::uuid(),
            'student_id'    => auth()->id(),
